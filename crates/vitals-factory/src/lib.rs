...
//! (`vitals_web::ward::Pack`): a case the ward holds, a person we invented, and her picture.
//! Nothing here writes medicine, decides who is admitted, or touches a key.
//!
//! The parts are split by what can be tested without a network: planning a pack is a pure function
//! over the ward's case list, the pool, the portrait manifest and the ward's last answer; the door
//! and the tools (mflux, cwebp, gcloud, Vertex) sit behind traits with fakes.
