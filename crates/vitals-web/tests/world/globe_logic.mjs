...
assert.deepEqual([t.from, t.years], [[2008, 0.5], 15], '2015 is only eight years back and 2008 fifteen; 2013 is nearer 2015 — 2015 wins');
assert.equal(t.pct_per_year, 0);
t = tenYearTrend([[2003, 0.5], [2015, 0.5], [2023, 0.5]]);
assert.deepEqual(t.from, [2015, 0.5], 'eight years back is the floor, and it counts');
